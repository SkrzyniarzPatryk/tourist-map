  ...
  const handleAddComment = async (e) => {
    ...
    try {
      ...
      const updatedCommentsResponse =
        await commentsService.getCommentsByPointId(id);
      setComments(updatedCommentsResponse);

      // Oblicz nową średnią ocenę
      const totalRating = updatedCommentsResponse.reduce(
      ...
      <Row md={8}>
        <div className="mt-4 p-4 border rounded bg-dark text-white">
          <p>
            ...
            {category.list.find((cat) => cat.id === parseInt(point.category))
                      ...
                      <div className="d-flex justify-content-between align-items-center mb-2">
                        <div className="d-flex align-items-center">
                          ...
                          <span className="text-warning">
                            <i className="bi bi-star-fill"></i> {comment.rating}
                            /5
                          </span>
                        </div>
                      </div>
            ...
            <Form onSubmit={handleAddComment}>
              <Form.Group controlId="rating">
                ...
                <Form.Text className="text-light">
                  Możesz wpisać ocenę z dokładnością do jednego miejsca po
                  przecinku (np. 4.5)
                </Form.Text>
              </Form.Group>
